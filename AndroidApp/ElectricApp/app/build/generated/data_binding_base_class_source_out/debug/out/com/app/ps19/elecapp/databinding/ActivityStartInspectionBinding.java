...
public final class ActivityStartInspectionBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout llExpEndMpValue;
  ...
  @NonNull
  public final TextView tvExpEndMpTitle;
  ...
  private ActivityStartInspectionBinding(@NonNull ScrollView rootView, @NonNull Button btnCancel,
      @NonNull Button btnOk, @NonNull EditText etExpEndMp,
      @NonNull EditText etInspectionTypeDescription, @NonNull EditText etSelectedNearbyAsset,
      @NonNull EditText etWeatherConditions, @NonNull EditText etWorkplanStartMp,
      @NonNull LinearLayout llExpEndMpValue, @NonNull LinearLayout llInspectionType,
      @NonNull LinearLayout llListSharingMembers, @NonNull LinearLayout llMpValue,
      @NonNull LinearLayout llNearbyAssets, @NonNull LinearLayout llSharingInspection,
      ...
      @NonNull RadioGroup rgTraverseType, @NonNull Spinner spAssetsAhead,
      @NonNull Spinner spAssetsBehind, @NonNull Spinner spTemperature,
      @NonNull Spinner spTraverseTrack, @NonNull TextInputLayout tiExpEndMp,
      @NonNull TextInputLayout tiStartMp, @NonNull TextView tvAssetAhead,
      @NonNull TextView tvAssetBehind, @NonNull TextView tvExpEndMpTitle,
      @NonNull TextView tvSharingInspectionMembersMsg, @NonNull TextView tvStartMpTitle,
    ...
    this.llExpEndMpValue = llExpEndMpValue;
    ...
    this.tvExpEndMpTitle = tvExpEndMpTitle;
  ...
  @NonNull
  public static ActivityStartInspectionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityStartInspectionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_start_inspection, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityStartInspectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ll_exp_end_mp_value;
      LinearLayout llExpEndMpValue = rootView.findViewById(id);
      if (llExpEndMpValue == null) {
        break missingId;
      }
      ...
      id = R.id.tv_exp_end_mp_title;
      TextView tvExpEndMpTitle = rootView.findViewById(id);
      if (tvExpEndMpTitle == null) {
        break missingId;
      }
      ...
      return new ActivityStartInspectionBinding((ScrollView) rootView, btnCancel, btnOk, etExpEndMp,
          etInspectionTypeDescription, etSelectedNearbyAsset, etWeatherConditions,
          etWorkplanStartMp, llExpEndMpValue, llInspectionType, llListSharingMembers, llMpValue,
          llNearbyAssets, llSharingInspection, llStartMp, llTraverseTrack, llWeatherConditions,
          lvSharingMembers, rbActionClass1, rbActionClass2, rbInspectionType1, rbInspectionType2,
          rbInspectionType3, rgInspectionType, rgTraverseType, spAssetsAhead, spAssetsBehind,
          spTemperature, spTraverseTrack, tiExpEndMp, tiStartMp, tvAssetAhead, tvAssetBehind,
          tvExpEndMpTitle, tvSharingInspectionMembersMsg, tvStartMpTitle, tvTempSign,
