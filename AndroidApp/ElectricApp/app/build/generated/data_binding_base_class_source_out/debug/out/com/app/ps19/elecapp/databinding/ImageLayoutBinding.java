...
public final class ImageLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final Button removeImgBtn;

  private ImageLayoutBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageSlide,
      @NonNull Button removeImgBtn) {
    this.rootView = rootView;
    this.imageSlide = imageSlide;
    this.removeImgBtn = removeImgBtn;
  }
  ...
  public static ImageLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imageSlide;
      ImageView imageSlide = rootView.findViewById(id);
      if (imageSlide == null) {
        break missingId;
      }

      id = R.id.removeImgBtn;
      Button removeImgBtn = rootView.findViewById(id);
      if (removeImgBtn == null) {
        break missingId;
      }

      return new ImageLayoutBinding((LinearLayout) rootView, imageSlide, removeImgBtn);
    }
