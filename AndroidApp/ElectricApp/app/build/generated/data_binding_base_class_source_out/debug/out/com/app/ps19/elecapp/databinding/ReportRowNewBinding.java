...
public final class ReportRowNewBinding implements ViewBinding {
  @NonNull
  ...
  private ReportRowNewBinding(@NonNull RelativeLayout rootView, @NonNull ImageView listImage,
      @NonNull LinearLayout reportThumbnailLayout, @NonNull TextView reportTitle,
      @NonNull TextView tvIssueDescription, @NonNull TextView tvIssueNotesCount,
      @NonNull TextView tvIssuePhotosCount, @NonNull TextView tvIssueRule,
      @NonNull TextView tvIssueType) {
  ...
  @NonNull
  public static ReportRowNewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ReportRowNewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.report_row_new, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ReportRowNewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ReportRowNewBinding((RelativeLayout) rootView, listImage, reportThumbnailLayout,
          reportTitle, tvIssueDescription, tvIssueNotesCount, tvIssuePhotosCount, tvIssueRule,
          tvIssueType);
    }
