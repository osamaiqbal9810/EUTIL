...
import static com.app.ps19.elecapp.Shared.Globals.FULL_DATE_FORMAT;
...
public class InboxActivity extends AppCompatActivity implements Observer{
   ...
   /* GPSService gService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.app.ps19.elecapp.taskAdapter adapter;
       /* startService(new Intent(this, GPSService.class));
        ...
        if (Globals.inbox.getJourneyPlans().size() == 0) {
            ...
            adapter = new com.app.ps19.elecapp.taskAdapter(this, Globals.inbox.getJourneyPlans().get(0).getTaskList());
        ...
        taskList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                findAndSetYardInspection();
                    ...
                    Intent intent = new Intent(InboxActivity.this, com.app.ps19.elecapp.TaskDashboardActivity.class);
        ...
        for (int i = 0; i < datesForSpinner.size(); i++) {
            ...
            if ((Globals.spinnerDayFormat.format(_date)).equals(Globals.spinnerDayFormat.format(currentDate))) {
                ...
                if (sJourneyPlan.getTaskList() == null) {
                    ...
                    com.app.ps19.elecapp.taskAdapter adapter = new com.app.ps19.elecapp.taskAdapter(InboxActivity.this, sJourneyPlan.getTaskList());
                    taskList.setAdapter(adapter);
                }
            }
        }
...
//cal.setTime(new Date());//Set specific Date if you want to
    ...
    protected void onResume() {
        ...
        //setDataAdapter();
        if(Globals.selectedJPlan != null ){
            com.app.ps19.elecapp.taskAdapter adapter = new com.app.ps19.elecapp.taskAdapter(InboxActivity.this, Globals.selectedJPlan.getTaskList());
            taskList.setAdapter(adapter);
        }
    }
