...
//                                                }
        ...
        sessionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(dayStarted){
                    ...
                    Intent intent = new Intent( MainActivity.this, com.app.ps19.elecapp.WorkPlanActivity.class);
       ...
       tryLocation();
            ...
            public void onClick(View v) {
                if (Globals.dayStarted) {
                    if(Globals.selectedJPlan.getTaskList().size() == 1){
                        ...
                        Intent intent = new Intent(MainActivity.this, com.app.ps19.elecapp.TaskDashboardActivity.class);
                        startActivity(intent);
                    } else {
        ...
        reportBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Globals.dayStarted) {
                    Intent intent = new Intent(MainActivity.this, com.app.ps19.elecapp.ReportInboxActivity.class);
                    startActivity(intent);
                }
            }
        });
