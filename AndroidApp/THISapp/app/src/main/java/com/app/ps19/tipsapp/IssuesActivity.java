...
import com.app.ps19.tipsapp.Shared.FragmentToActivityInterface;
...
import static com.app.ps19.tipsapp.IssueFragment.SECOND_ACTIVITY_REQUEST_CODE;
...
import static com.app.ps19.tipsapp.Shared.Globals.getBlinkAnimation;
...
import static com.app.ps19.tipsapp.Shared.Globals.isTimpsApp;
...
import static com.app.ps19.tipsapp.Shared.Utilities.getLocationDescription;
...
//    }
            ...
            switch (position){
                case 0:
                    if(isMaintainer && isTimpsApp()){
                        ...
                        return IssueFragment.newInstance("First", "#2E3192");
                    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IssueFragment.MAP_SELECTION_REQUEST_CODE) {
