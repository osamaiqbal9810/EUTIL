...
public class assetAdapter extends ArrayAdapter<DUnit> {
    private final Activity context;
    private ArrayList<DUnit> units;
    private String type;


    public assetAdapter(Activity context, String type, ArrayList<DUnit> _units) {
        super(context, R.layout.fixed_asset_select_row, _units);
    ...
    public View getCustomView(int position, View view, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.fixed_asset_select_row, null, true);
        ...
        ImageView titleImg = (ImageView) rowView.findViewById(R.id.iv_asset_row);
        TextView titleText = (TextView) rowView.findViewById(R.id.tv_asset_name_row);
        TextView descText = (TextView) rowView.findViewById(R.id.tv_asset_type_row);
        if (type.equals("static")) {
