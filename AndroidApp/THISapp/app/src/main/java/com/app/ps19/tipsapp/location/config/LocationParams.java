package com.app.ps19.tipsapp.location.config;
...
public class LocationParams {
    ...
    public static final LocationParams NAVIGATION = new Builder()
            ...
            .setDistance(LocationProvider.MIN_UPDATE_DISTANCE)
            .setInterval(LocationProvider.MIN_UPDATE_TIME).build();

    public static final LocationParams BEST_EFFORT = new Builder()
            .setAccuracy(LocationAccuracy.MEDIUM)
            .setDistance(LocationProvider.MEDIUM_UPDATE_DISTANCE)
            .setInterval(LocationProvider.MEDIUM_UPDATE_TIME).build();

    public static final LocationParams LAZY = new Builder()
            .setAccuracy(LocationAccuracy.LOW)
            .setDistance(LocationProvider.MAX_UPDATE_DISTANCE)
            .setInterval(LocationProvider.MAX_UPDATE_TIME).build();
