...
import com.app.ps19.tipsapp.Shared.MyDrawView;
        ...
        imgClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ScribbleNotesActivity.this,
                        getString(R.string.toast_msg_press_again_to_clear),Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(byte[]... data) {
            ...
            try {
               ...
               /* File dir=new File(Environment.getExternalStorageDirectory(), Globals.imageFolderName);
                ...
                File outFile = new File(getImgPath(fileName));
                if(outFile.exists())
                {
                    outFile.delete();
                }
