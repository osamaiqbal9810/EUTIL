...
import com.app.ps19.scimapp.InspectionStartActivity;
...
import static com.app.ps19.scimapp.Shared.Globals.changeItemList;
...
import static com.app.ps19.scimapp.Shared.Utilities.getScreenHeight;
...
//        tvUnitLocation = view.findViewById(R.id.tv_Unit_Loc);
    ...
    public class JPAreaAdapter extends RecyclerView.Adapter< JPAreaAdapter.MyViewHolder> {
        ...
        List<JPAreaAdapter.MyViewHolder> viewList = new ArrayList<>();
            ...
            MyViewHolder(View itemView) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        for(JPAreaAdapter.MyViewHolder holder : viewList){
        ...
        public  JPAreaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            JPAreaAdapter.MyViewHolder holder = new JPAreaAdapter.MyViewHolder(view);
            return holder;
        }

        @Override
        public void onBindViewHolder( JPAreaAdapter.MyViewHolder holder, int position) {
