package com.app.ps19.scimapp.classes.version;
...
public class Version implements IConvertHelper {
    ...
    public boolean isBypassVersionCheck() {
        return bypassVersionCheck;
    }

    public void setBypassVersionCheck(boolean bypassVersionCheck) {
    ...
    public boolean parseJsonObject(JSONObject jsonObject) {
        try {
            ...
            setBypassVersionCheck(jsonObject.optBoolean("bypassVersionCheck", false));
    ...
    public JSONObject getJsonObject() {
        ...
        try {
            ...
            jo.put("bypassVersionCheck", isBypassVersionCheck());
    ...
    private JSONObject getJsonObjectChanged(){
        ...
        try {
            ...
            putJSONProperty(jo,"bypassVersionCheck", isBypassVersionCheck());
