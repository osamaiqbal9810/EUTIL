package com.app.ps19.scimapp.safetyBriefing;
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        if(signatureImg != null){
            if(signatureImg.getImgName() == null || signatureImg.getImgName().equals("")){
                tvSigTitle.setText(context.getString(R.string.text_briefing));
                ...
                tvSigTitle.setText(context.getString(R.string.text_signature));
            }
        } else {
            tvSigTitle.setText(context.getString(R.string.text_briefing));
            Drawable d = context.getResources().getDrawable(R.drawable.phone_verify);
...
//set message
                .setMessage(context.getString(R.string.message_rmover_worker))
//set positive button
                .setPositiveButton(context.getString(R.string.briefing_yes), new DialogInterface.OnClickListener() {
                    @Override
