...
import com.app.ps19.hosapp.classes.AssetType;
...
import com.app.ps19.hosapp.classes.RptTimeAndGPS;
import com.app.ps19.hosapp.classes.SafetyBriefingForm;
import com.app.ps19.hosapp.classes.Task;
import com.app.ps19.hosapp.classes.Units;
import com.app.ps19.hosapp.classes.Worker;
...
public  class Globals {
    ...
    public static SimpleDateFormat spinnerDateFormat = new SimpleDateFormat("dd MMMM yyyy");
    public static SimpleDateFormat spinnerDayFormat = new SimpleDateFormat("EEEE");
    ...
    public static final String PREFS_KEY_SERVER = "TIPS SERVER INFO";
...
public static void setDomain() {
    ...
    public static void setUserInfoView(ImageView userImgView, TextView userNameView) {
        ...
        userNameView.setText(Globals.userName);
        /*try {
    ...
    public static <T> void circleImage(final ImageView imageView, T uri, final boolean border) {
        Glide.with(imageView.getContext()).load(uri).asBitmap().centerCrop().placeholder(R.drawable.ic_person_white_24dp).into(new BitmapImageViewTarget(imageView) {
            @Override
    ...
    public static int webUploadMessageLists(final Context context, String orgCode)
    {
        ...
        if(items.size()>0)
        {
            ...
            if(strRetValue.equals("success"))
            {
                intRetValue=db.UpdateMsgList(orgCode,items,MESSAGE_STATUS_POSTED);
