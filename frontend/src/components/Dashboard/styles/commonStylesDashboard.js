...
export const commonStylesDashboard = {
  summaryHeading: {
    ...
    electric: { margin: "5px 0px 5px", color: electricColors.second, padding: "0px 7.5px", fontWeight: 600 },
  },
  tableHeadings: {
    default: { margin: "5px -15px", color: basicColors.first },
    retro: { margin: "5px -15px", color: retroColors.second, fontWeight: 600 },
    electric: { margin: "5px -15px", color: retroColors.second, fontWeight: 600 },
  },
