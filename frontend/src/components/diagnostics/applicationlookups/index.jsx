...
class Applicationlookups extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      this.state.categories.forEach((categoryObj) => {
        ...
        if(!categoryObj.hasOwnProperty("opt1")) categoryObj.opt1 = {};
        if(!categoryObj.hasOwnProperty("opt2")) categoryObj.opt2 = {};
        if(typeof categoryObj.opt1 === 'object') categoryObj.opt1 = JSON.stringify(categoryObj.opt1);
        if(typeof categoryObj.opt2 === 'object') categoryObj.opt2 = JSON.stringify(categoryObj.opt2);
  ...
  handleEdit(field) {
    ...
    // try parsing objects in opt1 and opt2
    copyField.opt1 = this.tryParsingObject(copyField.opt1);
    copyField.opt2 = this.tryParsingObject(copyField.opt2);
