...
export const topBarStyle = {
  itemsStyle: {
    ...
    electric: { display: "inline-block", paddingRight: "12px" },
  },
  lineStyle: {
    default: { display: "inline-block", paddingRight: "12px" },
    retro: { display: "inline-block", paddingRight: "12px" },
  ...
  menuStyle: {
    ...
    electric: { marginTop: "7px", display: "inline-block" },
  },
  headerStyle: {
    default: {
    ...
    electric: {
      background: electricColors.sixth,
      ...
      zIndex: "100",
      borderBottom: "3px solid",
      borderBottomColor: electricColors.first,
    },
  },
  userAreaStyle: {
    default: {
  ...
  dividerStyle: {
    ...
    electric: {
      ...
      marginTop: "0px",
      overflow: "hidden",
      background: electricColors.fourth,
      height: "67px",
      display: "inline-block",
    },
  },
  coLogoStyle: {
    ...
    electric: { width: "202px", marginTop: "20px", verticalAlign: "top", padding: "0 10px" },
  },
  logoutStyle: {
    ...
    electric: { color: electricColors.fifth, verticalAlign: "top", marginRight: "10px" },
  },
  TTLogoStyle: {
    ...
    electric: { position: "absolute", top: "10px", left: "50%", transform: "translate(-50%,0)" },
  },
  centerLogoStyle: {
    default: { width: "202px", marginTop: "10px", verticalAlign: "top", padding: "0 10px" },
    retro: { width: "202px", verticalAlign: "top", padding: "0 10px" },
    electric: { width: "202px", verticalAlign: "top", padding: "0 10px" },
  },
};
...
export const ddElementStyle = themeService({
  ...
  electric: {
    backgroundColor: "rgb(255, 255, 255)",
    borderBottom: "1px solid" + electricColors.fourth,
    textAlign: "left",
