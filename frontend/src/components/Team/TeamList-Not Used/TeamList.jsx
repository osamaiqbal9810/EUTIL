	...
	constructor(props) {
		...
		this.columns = [
			...
			},
			{
				...
				id: "marked",
				accessor: d => {
					return <div style={{ color: "rgba(64, 118, 179)" }}>{d.marked && <SvgIcon size={20} icon={check} />}</div>;
				},
				getHeaderProps: () => {
					return {
						style: {
					...
					<Col md="11">
						<Row  style={{ margin : "0px" , padding : "15px"}}>
							<Col md="3" style={issuesReportedSummaryStyle.cardContainer}>
								<CardTypeOne number="7" numberColor="rgba(64, 118, 179)" topRight="" text="TOTAL TEAMS" />
							</Col>
							<Col md="3" style={issuesReportedSummaryStyle.cardContainer}>
