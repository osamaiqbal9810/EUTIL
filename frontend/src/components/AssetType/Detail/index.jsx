  ...
  handleAssetTypeAttributeAction = (actionType, selectedObj) => {
    if (actionType === MODAL_TYPES.VIEW) {
      this.props.history.push({
        pathname: `/setup/assetType/${this.state.assetType.assetType.replace(/\s+/g, "-").toLowerCase()}/${selectedObj.title
          .replace(/\s+/g, "-")
          .toLowerCase()}`,
    ...
    return (
      <div>
        ...
        <Row style={{ margin: "0px" }}>
            ...
            <div style={this.styles.MaintenanceDetailsContainer}>
              <Row>
                <Col md={"4"}>
                  ...
                  <div style={this.styles.fieldText}>{m1.assetType}</div>
                </Col>
                <Col md={"4"}>
          ...
          <Col md="12">
            <AttributesTable data={this.state.assetTypeAttributes} handleAssetTypeAttributeAction={this.handleAssetTypeAttributeAction} />
          </Col>
        </Row>
      </div>
    );
