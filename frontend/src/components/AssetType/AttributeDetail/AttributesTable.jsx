...
class AttributesDetailTable extends Component {
  constructor(props) {
    super(props);
    ...
    this.columns = [
      ...
      {
        Header: languageService("order"),
        id: "order",

        accessor: d => {
          return <div style={{ textAlign: "center" }}>{d.order} </div>;
        },
        minWidth: 30,
      },
      {
        Header: languageService("Initial value"),
        id: "value",

        accessor: d => {
          return <div style={{ textAlign: "center" }}>{d.value} </div>;
        },
        minWidth: 150,
      },
      {
        Header: languageService("type"),
        id: "type",

        accessor: d => {
          return <div style={{ textAlign: "center" }}>{d.type} </div>;
        },
        minWidth: 50,
      },
      {
        ...
        accessor: d => {
          return (
            <div>
              <ButtonActionsTable
                handleClick={() => {
                  this.props.handleEdit(MODAL_TYPES.EDIT, d);
                }}
...
export default AttributesDetailTable;
