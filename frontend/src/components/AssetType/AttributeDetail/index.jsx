...
class AssetTypeAttributeDetail extends Component {
  ...
  componentDidMount() {
    ...
    switch (assetTypeAttribute.title) {
      case "lampAttributes":
        assetTypeAttributeFields = assetTypeAttribute.data
          ? Object.keys(assetTypeAttribute.data).map((key) => ({
      ...
      default:
        assetTypeAttributeFields = assetTypeAttribute.data
          ? Object.keys(assetTypeAttribute.data).map((key) => ({
              name: key,
              value: assetTypeAttribute.data[key],
            }))
          : [];
    }
    ...
    return (
      <div>
        ...
        <Row style={{ margin: "0px" }}>
          ...
          <Col md="12">
            <AttributesTable data={this.state.assetTypeAttributeFields} handleEdit={this.handleModals} />
          </Col>
        </Row>
      </div>
    );
