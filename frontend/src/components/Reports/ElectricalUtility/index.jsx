                ...
                <Col md={12}>
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr className="new-block">
                        <td colSpan="3">
                          <h6>Primary Wire/Broken Ties</h6>
                        </td>
                        <td>0</td>
                        <td>0</td>
                        <td>0</td>
