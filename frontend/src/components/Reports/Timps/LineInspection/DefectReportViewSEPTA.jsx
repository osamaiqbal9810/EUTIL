              ...
              <Row>
                <Col md={12}>
                  <table>
                    <thead>
                      <tr>
                        <th data-field="station" style={{ width: "10px" }}>
                          {"Station"}
                        </th>
                        ...
                        <th data-field="geo" style={{ width: "5px" }}>
                          {"GEO."}
                        </th>
                        <th data-field="fixsec" style={{ width: "10px" }}>
                          {"Fixation Rail section"}
                        </th>
                        <th data-field="typetrack" style={{ width: "5px" }}>
                          {"TYPE TRACK"}
                        </th>
                ...
                <Col md={12}>
                  <div>
                    ...
                    <p style={{ textAlign: "left" }}>
                      1. Geomentry: T=Tangent track, C=Curve, G=Guarded curve, V=Vertical curve, S=Special work
                    </p>
                    <p>
                      2. Fixation and Rail Section:(100-ASCE canted) (100-ARA-B Canted) (100-ARA-B Pandrol) (115-RE Double shoulder) (115-RE
                      ZLR Pandrol) <br />
                      (Lord Pandrol) (lord low restraint) (Lord high restraint) (C and d clips) (RL-59)(128)(149)(134)(152)
                    </p>
                    <p>
