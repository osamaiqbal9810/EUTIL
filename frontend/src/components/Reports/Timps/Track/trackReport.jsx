...
const TrackReportContainer = CRUDFunction(TrackReport, "TrackInspectionReportTask", actionOptions, variableList, ["journeyPlanReducer"]);
export default TrackReportContainer;
