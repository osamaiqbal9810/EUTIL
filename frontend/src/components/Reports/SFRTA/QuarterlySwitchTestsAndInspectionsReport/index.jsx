...
import { SFRTA_QuarterlySwitchTestsAndInspectionsReportSchema } from "./SFRTA_QuarterlySwitchTestsAndInspectionsReportSchema";
import ReportFraInfoSection from "../../../../libraries/ReportGenerator/ReportFraInfoSection";
...
const ReportView = (props) => {
  ...
  return (
    <div id="mainContent" className="table-report" style={{ ...themeService(switchReportStyle.mainStyle), pageBreakAfter: "always" }}>
      <ReportTitleSection title="Inspection Report - Switch Tests & Inspections" {...props} />
      <span className="spacer"></span>
      <ReportFraInfoSection />
      <ReportFraConditionsMasterKey masterKey={masterKey} />
      <span className="spacer"></span>
      <table className="table-bordered">
        {SFRTA_QuarterlySwitchTestsAndInspectionsReportSchema.sections.map((section) => {
...
const SFRTA_QuarterlySwitchTestsAndInspectionsReport = (props) => {
  const { inspec } = props;
  return (
    <ReportView
      {...props}
...
export default SFRTA_QuarterlySwitchTestsAndInspectionsReport;
