...
import { SFRTA_MonthlySwitchTestsAndInspectionsReportSchema } from "./SFRTA_MonthlySwitchTestsAndInspectionsReportSchema";
  ...
  return (
    <div id="mainContent" className="table-report" style={{ ...themeService(switchReportStyle.mainStyle), pageBreakAfter: "always" }}>
      ...
      <table className="table-bordered">
        {SFRTA_MonthlySwitchTestsAndInspectionsReportSchema.sections.map((section) => {
...
const SFRTA_MonthlySwitchTestsAndInspectionsReport = (props) => {
  const { inspec } = props;
  return (
    <ReportView
      {...props}
...
export default SFRTA_MonthlySwitchTestsAndInspectionsReport;
