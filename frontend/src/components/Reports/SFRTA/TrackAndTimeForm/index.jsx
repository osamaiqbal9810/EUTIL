...
import { SFRTA_TrackAndTimeReportSchema } from "./SFRTA_TrackAndTimeReportSchema";
  ...
  return (
    <div id="mainContent" className="table-report" style={{ ...themeService(switchReportStyle.mainStyle), pageBreakAfter: "always" }}>
      ...
      <table className="table-bordered">
        {SFRTA_TrackAndTimeReportSchema.sections.map((section, i) => {
...
const SFRTA_TrackAndTimeForm = (props) => <ReportView {...props} />

export default SFRTA_TrackAndTimeForm;
