...
import { SFRTA_LockingTestsAndInspectionsReportSchema } from "./SFRTA_LockingTestsAndInspectionsReportSchema";
...
const ReportView = (props) => {
  ...
  return (
    <div id="mainContent" className="table-report" style={{ ...themeService(switchReportStyle.mainStyle), pageBreakAfter: "always" }}>
      <ReportTitleSection title="Inspection Report - Locking Tests & Inspections" {...props} />
      <span className="spacer"></span>
      <ReportFraInfoSectionContainer />
      <ReportFraConditionsMasterKey masterKey={masterKey} />
      <span className="spacer"></span>
      <table className="table-bordered">
        {SFRTA_LockingTestsAndInspectionsReportSchema.sections.map((section) => {
...
const SFRTA_LockingTestsAndInspectionsReport = (props) => {
  const { inspec } = props;
  return (
    <ReportView
      {...props}
...
export default SFRTA_LockingTestsAndInspectionsReport;
