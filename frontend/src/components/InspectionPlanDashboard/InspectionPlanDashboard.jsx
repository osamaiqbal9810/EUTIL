...
class InspectionPlanDashboard extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="location-selection-main site-not" id="mainContent">
        <Row>
          <Col md={3}>
...
const InspectionPlanDashboardContainer = CRUDFunction(
...
export default InspectionPlanDashboardContainer;
