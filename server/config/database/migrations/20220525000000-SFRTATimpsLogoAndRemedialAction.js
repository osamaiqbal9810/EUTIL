...
module.exports = {
  async up() {
    ...
    await ApplicationLookupsModel.updateOne({listName: "Customer"},{$set:{"opt1.appearance.logo1":"transdev"}});
    await ApplicationLookupsModel.updateOne({listName: "Customer"},{$set:{"opt1.appearance.logo2":"trirail"}});
  },
  attributes: { applicationType: "TIMPS", customer: "South Florida Regional Transportation Authority" },
};
