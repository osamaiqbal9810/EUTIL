...
module.exports = {
  async up() {
    ...
    await updateApplicationLookups([
      { listName: "appForms", code: "onrTurnoutForm", compare: "opt1" },
      { listName: "appForms", code: "onrSafetyBriefing", compare: "opt1" },
      { listName: "appForms", code: "onrsafetyWatchBriefing", compare: "opt1" },
    ]);
  },
