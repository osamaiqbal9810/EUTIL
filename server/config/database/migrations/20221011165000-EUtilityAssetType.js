...
module.exports = {
  async up() {
    ...
    await addAssetMethod(DistributionOverheadFac);
    await addAssetMethod(Transmission);
    await addAssetMethod(UndergroundFacilitiesPadmountSwitchgear);
    await addAssetMethod(PadmountTransformers);
    await addAssetMethod(Streetlight);
