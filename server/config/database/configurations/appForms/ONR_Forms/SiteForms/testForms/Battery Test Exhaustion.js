export const batteryTestExhaustion = [
  {
    id: "Inspected",
  ...
  },
  {
    id: "desc",
    fieldName:
      "Review previous 4 month readings to verify there are now sudden drops in voltages indicating battery exhaustion.  Fill in Battery Record Card if adjustments are made",
    fieldType: "label",
  },
  {
    id: "test",
