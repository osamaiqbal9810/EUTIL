export const secondaryBatteryTest = [
  {
    id: "Inspected",
  ...
  },
  {
    id: "desc",
    fieldName:
      "Inspect batteries, terminals, polarity and veintilation.  Perform tests and record battery readings on SSIT-F-001 Battery Record Card.  Repeat for each battery bank",
    fieldType: "label",
  },
  {
    id: "test",
