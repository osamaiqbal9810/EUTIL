...
class JPUpdateSuccessWorker {
    ...
    try {
      ...
      switch (this.actionType) {
        case actionTypes.JP_UPDATE_SUCCESS:
          ...
          await this.DBService.updateATIVData(this.itm);
          await this.DBService.checkEquipmentFormWithoutTestFormAndReplacementForms(this.itm);
  ...
  isEqualsTo(anotherWorker) {
    if (anotherWorker instanceof JPUpdateSuccessWorker) {
